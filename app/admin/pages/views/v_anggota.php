                                            ...
                                            <div class="modal-content" style="border-radius: 5px;">
                                                ...
                                                <form action="pages/function/Anggota.php?aksi=edit" enctype="multipart/form-data" method="POST">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label>TTL <small style="color: red;">* Wajib diisi</small></label>
                                                            <input type="text" class="form-control" placeholder="Masukan Tanggal dan Tahun lahir" name="tanggallahir" required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label>Gender <small style="color: red;">* Wajib diisi</small></label>
                                                            <select class="form-control" name="kelamin">
                                                                <?php
                                                                if ($row['kelamin'] == null) {
                                                                    echo "<option selected disabled>Silahkan pilih gender dari [" . $row['fullname'] . "]</option>";
                                                                } else {
                                                                    echo "<option selected value='" . $row['kelamin'] . "'>" . $row['kelamin'] . " ( Dipilih Sebelumnya )</option>";
                                                                }
                                                                ?>
