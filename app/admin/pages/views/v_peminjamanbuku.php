                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tgl-pinjam">
                            <section id="new">
                                ...
                                $namaAnggota = $_SESSION['fullname'];
                                $sql = mysqli_query($koneksi, "SELECT * FROM peminjaman WHERE nama_anggota = '$namaAnggota' AND tanggal_pengembalian = ''");
                                $hasil = mysqli_num_rows($sql);
                                ?>

                                <?php
                                if ($hasil > 0) {
                                    $sql3 = mysqli_query($koneksi, "SELECT * FROM peminjaman WHERE nama_anggota = '$namaAnggota' AND tanggal_pengembalian = ''");
                                ...
                                <form action="pages/function/Peminjaman.php?aksi=pinjam" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Masukan Nama Pengguna" name="nama_anggota" required>
                                    </div>
                                    <div class="form-group">
                                        <label>TTL</label>                                        
                                        <input type="text" class="form-control" placeholder="Masukan Tanggal dan Tahun lahir" name="tanggallahir" required>
                                    </div>
                                    <div class="form-group">
                                        <label>Gender</label>
                                        <select class="form-control" name="kelamin">
                                            <?php
                                            if ($row['kelamin'] == null) {
                                                echo "<option selected disabled>Silahkan pilih gender</option>";
                                            } else {
                                                echo "<option selected value='" . $row['kelamin'] . "'>" . $row['kelamin'] . " ( Dipilih Sekarang )</option>";
                                            }
                                            ?>
                        ...
                        <div class="tab-pane" id="tgl-pengembalian">
                            <table class="table table-bordered" id="example1">
                                ...
                                $query = mysqli_query($koneksi, "SELECT * FROM peminjaman WHERE nama_anggota = '$namaAnggota'");
