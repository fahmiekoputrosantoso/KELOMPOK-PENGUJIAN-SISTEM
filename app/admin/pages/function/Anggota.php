...
if ($_GET['aksi'] == "tambah") {
    ...
    $sql = "INSERT INTO user(kode_user,nis,fullname,ttl,gender,username,password,kelas,alamat,verif,role,join_date)
        VALUES('" . $kode_anggota . "','" . $nis . "','" . $fullname . "','" . $ttl . "','" . $gender . "','" . $username . "','" . $password . "','" . $kelas . "','" . $alamat . "','" . $verif . "','" . $role . "','" . $join_date . "')";
    ...
    $tanggallahir = htmlspecialchars(strtolower($_POST['tanggallahir']));
    $kelamin = htmlspecialchars(strtolower($_POST['kelamin']));
    $username = htmlspecialchars(strtolower($_POST['uSername']));
    $password = htmlspecialchars(trim($_POST['pAssword']));
    $kelas = htmlspecialchars(addslashes($_POST['kElas']));
    $alamat = htmlspecialchars(addslashes($_POST['aLamat']));

    $query = "UPDATE user SET nis = '$nis', fullname = '$nama_lengkap', ttl = '$tanggallahir', gender = '$kelamin', username = '$username', 
